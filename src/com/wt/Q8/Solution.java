...
public class Solution {
	public static int myAtoi(String str) {
		...
		String string = "";
		int num = str.length();
		if (num == 0 || (num == 1 && ((str.charAt(0) + "").equals("+") || (str.charAt(0) + "").equals("-")))) {
			return 0;
		}

		if (!Character.isDigit(str.charAt(0))
				&& !((str.charAt(0) + "").equals("+") || (str.charAt(0) + "").equals("-"))) {
			return 0;
		}
		string += str.charAt(0);
	...
	public static void main(String[] args) {
		String s = "20000000000000000000000000000";
//		Integer.parseInt(s);
